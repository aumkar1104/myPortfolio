  ...
  return (
    <main style={{ width: '100%', minHeight: '100vh', position: 'relative', background: '#050505', color: 'white' }}>
      ...
      <div style={{ 
        ...
        <h1 style={{ fontSize: '3rem', fontFamily: 'monospace', color: '#00ccff', borderBottom: '1px solid #333', paddingBottom: '20px', marginBottom: '50px', letterSpacing: '4px' }}>
          // FEATURED_WORK
        </h1>
          ...
          {myProjects.map((p, i) => (
            ...
            onMouseLeave={(e) => {
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '20px', marginTop: 'auto' }}>
                  ...
                  {/* Tech Stack Pills (Matches Certifications exactly) */}
                  ...
                  {/* View Repository Button (Matches Certifications exactly) */}
